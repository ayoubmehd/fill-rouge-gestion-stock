                        ...
                        <form method="post" action="{{ route('admin.produits.store') }}">
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" name="name" id="username" class="form-control" placeholder="{{ __('admin.produits.form.name.lable') }}" aria-describedby="helpId" />
                                ...
                                <div class="form-group col-3">
                                    ...
                                    <input type="number" name="prix" id="prix" class="form-control" placeholder="{{ __('admin.produits.form.prix.lable') }}" aria-describedby="helpId" />
                                ...
                                <div class="form-group col-3">
                                    ...
                                    <input type="number" name="quantite" id="quantite" class="form-control" placeholder="{{ __('admin.produits.form.quantite.lable') }}" aria-describedby="helpId" />
